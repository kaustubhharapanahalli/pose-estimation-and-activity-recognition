...
#added by me for converting the code to obtain images from a folder
...
def draw_person_pose(orig_img, poses):
	...
	image3 = canvas - orig_img
	image3 = cv2.bitwise_not(image3)
	cv2.imwrite('predict/image.jpg',image3)
	predictModel()
	return canvas
...
"""
Predicting the action being performed in the image taken as input
"""
